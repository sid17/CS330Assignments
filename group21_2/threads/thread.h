...
class Thread {
  ...
  public:
    ...
    void PrintRegisters(); //Prints the value of user registers

    void SetInitRegisters(int num); //Prints the value of user registers
...
public:  // Scheduler public variables for thread 
int Previous_Cpu_Burst, Estimated_Cpu_Burst;
int Time_To_Enter_Ready_Queue,Time_To_Exit_Ready_Queue;
int Thread_Start_Time, Thread_Exit_Time;
int Burst_Counter,Burst_Length,Thread_Wait_Time ;
int Thread_Start_Execution;
int Start_Sleep;
int Total_Sleep;
