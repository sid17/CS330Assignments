...
class Condition {
  public:
   ...
   void Wait(Semaphore *conditionSemaphore);  // these are the 3 operations on 
                    // condition variables; releasing the 
                    // lock and going to sleep are 
                    // *atomic* in Wait()
  ...
  private:
    char* name;
    // plus some other stuff you'll need to define
    List *queue;       // threads waiting on a particular condition variable
};
#endif // SYNCH_H
