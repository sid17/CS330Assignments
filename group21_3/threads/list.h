...
typedef dllist list;
typedef dllist * listpt;
#define  pint(n) printf("%d",n) 

void printlist(listpt free) ;
nodept createnode(int len);
int deleted(listpt free,nodept curr)  ;
int insertd(listpt free,nodept curr);
